...
_export(exports, {
    ...
    getAssetIdForLogGrouping: ()=>getAssetIdForLogGrouping,
    ...
    for (const asset1 of assetsToCopy){
        ...
        for(let idx = 0; idx < asset1.scales.length; idx++){
            ...
            if (validScales.has(scale)) {
                const src = asset1.files[idx];
                const dest = (0, _metroAssetLocalPath.getAssetLocalPath)(asset1, {
                    platform,
                    scale,
                    baseUrl
                });
                if (files) {
                    ...
                    files.set(dest, {
                        contents: data,
                        assetId: getAssetIdForLogGrouping(projectRoot, asset1),
